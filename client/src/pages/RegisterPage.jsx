...
export default function RegisterPage() {
  ...
  return (
    <div style={{
      ...
      backgroundImage: `radial-gradient(circle at 20% 50%, rgba(124,106,247,0.08) 0%, transparent 50%),
      ...
      <div style={{ position:'fixed', bottom:'-15%', left:'-10%', width:500, height:500, borderRadius:'50%',
        background:'radial-gradient(circle, rgba(62,207,142,0.08) 0%, transparent 70%)', pointerEvents:'none' }} />
      <div style={{ width:'100%', maxWidth:440, animation:'fadeIn 0.4s ease' }}>
        ...
        <div style={{
          ...
          <form onSubmit={handleSubmit} style={{ display:'flex', flexDirection:'column', gap:'1.1rem' }}>
            <Input label="Full Name" placeholder="Arjun Sharma" icon={User}
              value={form.name} onChange={set('name')} error={errors.name} autoComplete="name" />
            <Input label="Email Address" type="email" placeholder="arjun@example.com" icon={Mail}
            ...
            <Button type="submit" loading={loading} fullWidth size="lg" style={{ marginTop:'0.4rem' }}>
              Create Account
            </Button>
          </form>
